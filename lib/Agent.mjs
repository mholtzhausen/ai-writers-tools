...
export class Agent extends EventEmitter {
	...
	async ask(prompt, config, schema) {
		...
		let iMessages = [...messages, { role: "user", content: prompt }]
		...
		this.messages = [...iMessages, { role: "assistant", content: response.choices[0].message.content }]
